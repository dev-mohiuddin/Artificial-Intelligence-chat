        ...
        <div className='w-80 py-8 rounded-md cardcol shadow-2xl border border-gray-400 dark:border-gray-600 dark:bg-slate-900 p-5 flex flex-col gap-3 justify-center'>
            <form className='flex flex-col gap-5'>
                <div className='flex flex-col gap-2'>
                    ...
                    <input className='outline-none px-2 py-1 rounded-md bg-slate-50 dark:bg-slate-800 pcol' type="text" placeholder='Name' required />
                </div>
                <div className='flex flex-col gap-2'>
                    <label className='text-base hcol' htmlFor="">Email</label>
                    <input className='outline-none px-2 py-1 rounded-md bg-slate-50 dark:bg-slate-800 pcol' type="email" placeholder='Email' name="" required />
                </div>
                <div className='flex flex-col gap-2'>
                    <label className='text-base hcol' htmlFor="">Password</label>
                    <input className='outline-none px-2 py-1 rounded-md bg-slate-50 dark:bg-slate-800 pcol' type="password" placeholder='Password' name="" required />
                </div>
                <div className='flex flex-col gap-2'>
                    <label className='text-base hcol' htmlFor="">Confirm password</label>
                    <input className='outline-none px-2 py-1 rounded-md bg-slate-50 dark:bg-slate-800 pcol' type="password" placeholder='confirm password' name="" required />
                </div>
