      ...
      <div className='relative w-4/5 h-full bg-slate-100 dark:bg-slate-900 right-0'>
        ...
        <div className='flex flex-col gap-4 mt-12 px-4'>
          <div className='relative flex items-center '>
            <input className='h-8 outline-none px-3 w-full md:w-72 rounded-full md:rounded-md border bg-slate-100 border-gray-400 dark:border-gray-600 focus:border-blue-300 pcol dark:bg-gray-900' type="text" name="" id="" />
