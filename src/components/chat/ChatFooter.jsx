...
function ChatFooter() {
  return (
    <div className='w-full'>
      <div className=' bg-gradient-to-l from-pink-50 via-purple-50 to-pink-50 px-3 border border-x-0 border-b-0 border-t-gray-400 dark:border-t-gray-600 dark:bg-gradient-to-l from-transparent via-slate-950 to-transparent md:dark:bg-gradient-to-r from-transparent via-transparent to-transparent'>
