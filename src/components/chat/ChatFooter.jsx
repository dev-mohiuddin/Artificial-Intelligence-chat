...
function ChatFooter() {
  return (
    <div className='fixed bottom-0 w-full flex'>
      <div className='w-[768px]  bg-gradient-to-l from-pink-50 via-purple-50 to-pink-50 px-3 border border-x-0 border-b-0 border-t-gray-400 dark:border-t-gray-600 dark:bg-gradient-to-l from-slate-900 via-slate-900 to-slate-900 md:dark:bg-gradient-to-r from-transparent via-transparent to-transparent'>
