    ...
    return (
        <>
            <Link to={`/chat/${persion?._id}`} >
                <div className=' cursor-pointer border border-gray-300 dark:border-gray-700 h-60 w-48 flex px-2 py-3 rounded-md hover:scale-105 duration-500 flex-col justify-between overflow-hidden cardcol shadow'>
